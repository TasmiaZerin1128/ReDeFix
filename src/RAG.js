...
async function main() {
  try {
    const collision_threads = JSON.parse(fs.readFileSync('Input/Knowledge_Base/stackoverflow_collision_threads.json', 'utf-8'));
    const protrusion_threads = JSON.parse(fs.readFileSync('Input/Knowledge_Base/stackoverflow_protrusion_threads.json', 'utf-8'));
    const viewport_protrusion_threads = JSON.parse(fs.readFileSync('Input/Knowledge_Base/stackoverflow_protrusion_threads.json', 'utf-8'));
    const wrapping_threads = JSON.parse(fs.readFileSync('Input/Knowledge_Base/stackoverflow_wrapping_threads.json', 'utf-8'));
